...
<table>
    ...
    <?php foreach ($billets as $billet): ?>
        ...
        <tr>
            ...
            <td><a id="bouton" href="admin/edit/<?= $billet['id'] ?>"><input type="button" name="Editer" value="Editer"
                                                                             class="bouton1"></a>
            <td><a id="bouton" href="admin/delete/<?= $billet['id'] ?>"><input type="button" name="Supprimer"
                                                                               value="Supprimer"
